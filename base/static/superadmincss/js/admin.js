...
labelsBtnEl.classList.add("admin-content-headings-btn-active");
postsBtnEl.classList.remove("admin-content-headings-btn-active");
clipsBtnEl.classList.remove("admin-content-headings-btn-active");
...
function functionPosts(){
    ...
    labelsBtnEl.classList.remove("admin-content-headings-btn-active");
    postsBtnEl.classList.add("admin-content-headings-btn-active");
    clipsBtnEl.classList.remove("admin-content-headings-btn-active");
}
...
function functionClips(){
    ...
    labelsBtnEl.classList.remove("admin-content-headings-btn-active");
    postsBtnEl.classList.remove("admin-content-headings-btn-active");
    clipsBtnEl.classList.add("admin-content-headings-btn-active");
}
