...
/*Booster 1*/
const booster1Num = document.getElementById("booster1Num");
const booster1Bar = document.getElementById("booster1Bar");
booster1Bar.style.width=  booster1Num.textContent + "px";
booster1Bar.style.backgroundColor = "red";